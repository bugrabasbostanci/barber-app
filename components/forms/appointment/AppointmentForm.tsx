...
interface AppointmentFormProps {
  ...
  onSubmit: (
    data: AppointmentFormData | ManualAppointmentFormData
  ) => Promise<void>;
  onCancel?: () => void;
  loading?: boolean;
...
export const AppointmentForm = ({
  ...
  const [formData, setFormData] = useState<
    AppointmentFormState | ManualAppointmentFormState
  >({
  ...
  const validateForm = () => {
    ...
    if (!formData.date) {
      setErrors({ date: "Date selection is required" });
      return false;
    }
    ...
    const schema =
      mode === "barber" ? manualAppointmentFormSchema : appointmentFormSchema;
  ...
  const getTitle = () => {
    ...
    return mode === "barber" ? "Create Appointment" : "Book Appointment";
  };
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="You can write special notes about the appointment..."
              disabled={loading}
              rows={3}
              maxLength={500}
              className={`${
      ...
      <div className="flex gap-3 justify-end">
        ...
        <Button type="submit" disabled={loading}>
          ...
          {mode === "barber" ? "Create Appointment" : "Book Appointment"}
        </Button>
      </div>
    </form>
  );
