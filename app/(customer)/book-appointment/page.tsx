    ...
    switch (currentStep) {
        ...
        return (
          <div className="space-y-6 pb-24">
            <div className="text-center">
              <Calendar className="w-12 h-12 mx-auto text-blue-600 dark:text-blue-400 mb-4" />
      ...
      case 2:
        return (
          <div className="space-y-6 pb-24">
            <div className="text-center">
              <UserCheck className="w-12 h-12 mx-auto text-blue-600 dark:text-blue-400 mb-4" />
      ...
      case 3:
        return (
          <div className="space-y-6 pb-24">
            <div className="text-center">
              <Clock className="w-12 h-12 mx-auto text-blue-600 dark:text-blue-400 mb-4" />
      ...
      case 4:
        return (
          <div className="space-y-6 pb-24">
            <div className="text-center">
              <Phone className="w-12 h-12 mx-auto text-blue-600 dark:text-blue-400 mb-4" />
            ...
            {[1, 2, 3, 4].map((stepNum) => (
              <div
                ...
                className={`flex-1 h-2 rounded-full transition-all ${
                  stepNum <= currentStep ? "bg-blue-500 dark:bg-blue-400" : "bg-muted"
                }`}
              />
            ))}
          </div>
      ...
      {currentStep === 5 && (
        <div className="fixed bottom-0 left-0 right-0 bg-background border-t p-4 space-y-3">
          <button
            ...
            className="w-full h-14 text-base font-semibold bg-blue-600 dark:bg-blue-500 text-white rounded-lg hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors"
          >
            Başka Randevu Al
          </button>
        ...
        return (
          ...
          >
            <div className="flex items-center space-x-4">
              {/* Avatar */}
              <div className="w-12 h-12 bg-blue-600 dark:bg-blue-500 text-white rounded-full flex items-center justify-center font-semibold text-lg">
      ...
      {availableSlots.map((time) => (
        <button
          ...
          className={`p-4 rounded-xl border-2 transition-all ${
            selectedTime === time
              ? "border-blue-500 bg-blue-50 dark:bg-blue-950/30 font-semibold text-blue-700 dark:text-blue-300"
              : "border-border hover:border-muted-foreground/30"
          }`}
        >
          <div className="text-center">
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full h-24 p-3 text-base mt-2 border border-input rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          />
        </div>
      </div>
    </div>
